...
export function Footer(){
    ...
    return(
        <div className="w-auto h-auto relative">
            ...
            <div className="absolute ml-20 left-96 z-100 w-auto h-auto top-24 text-white text-center select-text">
                <h1 className="pt-3 pl-1 pb-3 text-xl font-semibold underline select-none">Adresa</h1>
