  ...
  return (
    <div>
      ...
      <div className="desktop bg-white w-full h-full relative select-none ">       
          ...
          <Slideshow />
          <svg className="z-20 top-4/4 min-2xl:-mt-13 -mt-11 absolute w-screen shadow-xl" style={{transform: "rotate(-183deg)"}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120">
            <defs>
